...
const AnimeMoviesPage: React.FC<AnimeMoviesPageProps> = ({ onBack }) => {
  const pageId = PageId.ANIME_MOVIES;
    ...
    <div className="min-h-screen bg-slate-950 text-slate-200 pb-10 fade-in flex flex-col">
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <img
            src={`${import.meta.env.BASE_URL}assets/hero_anime_movies.jpg`}
            onError={(e) => { e.currentTarget.style.display = 'none'; }}
            alt="Anime Movies Hero"
